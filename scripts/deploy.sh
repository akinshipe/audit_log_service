...
# Start the application and capture stderr
echo "---------------------------------------------------------------------Starting the application..."
echo "------------- Get Application access token here http://127.0.0.1:8000/access-token?valid_minutes=1800 "
if ! python3 -m uvicorn log_service.app_entry_point:app --host 0.0.0.0 --port 8000 --log-level warning 2>&1; then
